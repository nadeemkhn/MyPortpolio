      ...
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start'>
            ...
            <span className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-4xl rounded-md'>
              Odoo Developer and FrontEnd
            </span>
            <p className='mt-3'>
              As a skilled frontend and Odoo developer, I can customize a module from scratch and make changes to existing modules.
            </p>
            <p>
